!function (e, t) {
    ...
    function o(t) {
        ...
        if (o.innerHTML = b(t.title).split("\n").join("<br>"), r.innerHTML = b(t.text || "").split("\n").join("<br>"), t.text && w(r), x(n.querySelectorAll(".icon")), t.type) {
            for (var l = !1, s = 0; s < f.length; s++) if (t.type === f[s]) {
                l = !0;
                break
            }
            ...
            switch (w(u), t.type) {
                case"success":
                    g(u, "animate"), g(u.querySelector(".tip"), "animateSuccessTip"), g(u.querySelector(".long"), "animateSuccessLong");
                    break;
                case"error":
                    g(u, "animateErrorIcon"), g(u.querySelector(".x-mark"), "animateXMark");
                    break;
                case"warning":
                    g(u, "pulseWarning"), g(u.querySelector(".body"), "pulseWarningIns"), g(u.querySelector(".dot"), "pulseWarningIns")
            }
        }
        if (t.imageUrl) {
            ...
            d.setAttribute("style", d.getAttribute("style") + "width:" + p + "px; height:" + m + "px")
        }
    ...
    e.sweetAlert = e.swal = function () {
        function n(e) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(t)) {
                for (var n = e.target || e.srcElement, o = -1, r = 0; r < h.length; r++) if (n === h[r]) {
                    o = r;
                    break
                }
        ...
        function a(e) {
            ...
            if (o) {
                var r = -1;
                if (null !== n) {
                    for (var a = 0; a < h.length; a++) if (n === h[a]) {
                        r = a;
                        break
                    }
                    -1 === r && t.focus()
        ...
        for (var d = y(), f = function (e) {
            var t = e.target || e.srcElement, n = "confirm" === t.className, o = m(d, "visible"),
                a = u.doneFunction && "true" === d.getAttribute("data-has-done-function");
            switch (e.type) {
                case"mouseover":
                ...
                case"focus":
                    ...
                    break;
                case"click":
                    n && a && o && u.doneFunction(), l()
            }
        }, p = d.querySelectorAll("button"), g = 0; g < p.length; g++) p[g].onclick = f, p[g].onmouseover = f, p[g].onmouseout = f, p[g].onmousedown = f, p[g].onfocus = f;
        A = t.onclick, t.onclick = function (e) {
            var t = e.target || e.srcElement, n = d === t, o = k(d, e.target), r = m(d, "visible"),
                a = "true" === d.getAttribute("data-allow-ouside-click");
            !n && !o && r && a && l()
        };
        var v = d.querySelector("button.confirm"), b = d.querySelector("button.cancel"),
            h = d.querySelectorAll("button:not([type=hidden])");
